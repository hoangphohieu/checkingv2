            ...
            return (
                  <React.Fragment>
                        ...
                        <div className="row p-2 hover-pointer one-properties-tracking align-items-center" onClick={this.showProperties}>
                              ...
                              <div className={"col-2 text-center" + ((item.sumBaseCost - paid <= 0) ? " btn btn-success" : " btn btn-danger")}>
                        ...
                        {/* more */}
                        {
                              (this.state.show === true) ? <div className="row mb-1 justify-content-around">
                                    {/*  danh sách paid theo ngày */}
                                    <div className="col-3 height-table-paid">
                                    ...
                                    <div className="col-6">
                                          ...
                                          <p className="checking-item-altribute"><span className="checking-item-title">Pass Word:</span><span>{item.pass}</span></p>
                                          <p className="checking-item-altribute"><span className="checking-item-title">Product:</span><span>{item.product.join(",")}</span></p>
                                          <p className="checking-item-altribute"><span className="checking-item-title">Code:</span><span>{item.code.join(",")}</span></p>
                                          <p className="checking-item-altribute"><span className="checking-item-title">Router:</span><span>{(item.router === "R") ? "Đọc" : "Đọc, thêm, sửa, xóa"}</span></p>
                                          <p className="checking-item-altribute"><span className="checking-item-title">Partner:</span><span>{item.partner.substr(4)}</span></p>
                                          <p className="checking-item-altribute"><span className="checking-item-title">Phone Number:</span><span>{item.phone}</span></p>
                                          <p className="checking-item-altribute"><span className="checking-item-title">Note:</span><span>{item.note}</span></p>
                                          <div className="d-flex">
                                                <Button className="m-2" variant="primary" onClick={this.handleAddPaid}>
                                                      Add Paid
                                                </Button>
                                                <Button className="m-2" variant="primary" onClick={this.handleShow}>
                                                      Change
                                                </Button>
                                                <Button className="m-2" variant="danger" onClick={this.handleDeleteShow}>
                                                      Delete
                                                </Button>
                                          </div>
                                    </div>
